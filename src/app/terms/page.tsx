...
export const metadata: Metadata = {
  ...
  keywords: "terms of service, terms and conditions, legal, pdf converter, word converter",
}
          ...
          <div className="mx-auto max-w-3xl space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                Welcome to PDF Word Converter ("we," "our," or "us"). By accessing or using our website and services,
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                Our services allow you to convert PDF documents to Word format and Word documents to PDF format. By
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                ...
                explains how we collect, use, and protect your information. By using our services, you agree to our
                Privacy Policy.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                Our website and its original content, features, and functionality are owned by us and are protected by
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                You retain all rights to your content. By uploading content to our service, you grant us a
                non-exclusive, royalty-free license to use, store, and process your content solely for the purpose of
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                ...
                or that our services or the server that makes it available are free of viruses or other harmful
                components.
              </p>
            </div>
