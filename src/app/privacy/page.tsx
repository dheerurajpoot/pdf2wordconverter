...
export const metadata: Metadata = {
	...
	description:
		"Learn how we protect your privacy and handle your data when using our document conversion tools.",
	keywords:
		"privacy policy, data protection, security, pdf converter, word converter",
};
					...
					<div className='mx-auto max-w-3xl space-y-8'>
						<div className='space-y-4'>
							...
							<p className='text-gray-500'>
								At PDF Word Converter, we respect your privacy
						...
						<div className='space-y-4'>
							...
							<p className='text-gray-500'>
								Our document conversion service processes your
								files directly in your browser. This means:
							</p>
							<ul className='list-disc pl-6 text-gray-500 space-y-2'>
								<li>
									Your files are never uploaded to our
									servers.
								</li>
								<li>
									We do not have access to the content of your
									documents.
								</li>
								<li>
							...
							<ul className='list-disc pl-6 text-gray-500 space-y-2'>
								...
								<li>
									Length of visit, page views, website
									navigation
								</li>
								<li>
									Anonymized information about how you use our
									website
								</li>
							</ul>
						</div>
						...
						<div className='space-y-4'>
							...
							<p className='text-gray-500'>
								We use the anonymous usage data we collect to:
							</p>
							<ul className='list-disc pl-6 text-gray-500 space-y-2'>
						...
						<div className='space-y-4'>
							...
							<p className='text-gray-500'>
								...
								users of our website. This helps us to provide
							...
							<p className='text-gray-500'>
								...
								browser cookies, or to alert you when websites
								set or access cookies. If you disable or refuse
								cookies, please note that some parts of this
								website may become inaccessible or not function
								properly.
							</p>
						</div>
						...
						<div className='space-y-4'>
							...
							<p className='text-gray-500'>
								...
								websites, plug-ins, and applications. Clicking
								on those links or enabling those connections may
								allow third parties to collect or share data
								about you. We do not control these third-party
								websites and are not responsible for their
								privacy statements. When you leave our website,
								we encourage you to read the privacy policy of
